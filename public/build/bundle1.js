/* Cafe 0.0.92 Wed Mar 27 2013 14:26:48 GMT+0200 (EET) */
...
// Generated by CoffeeScript 1.6.1
(function() {
  var $, IDom, debug, dispatch_impl, error, in_subtree, info, jqidom, warn, _ref,
    __slice = [].slice;
...
'index': function(exports, require, module) {(function() {
(function() {
  var DEBUG, ERROR, INFO, LOGCFG, LOG_LEVELS, NOTICE, UNK_NS, WARN, and_, bool, bt, e, get_namespaced_logger, is_array, is_object, log, log_level_enabled, log_ns_enabled, nullog, or_, partial, say, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __slice = [].slice;
...
// Generated by CoffeeScript 1.6.1
(function() {
  var DEBUG, ERROR, INFO, LOGCFG, LOG_LEVELS, NOTICE, UNK_NS, WARN, and_, bool, bt, get_namespaced_logger, is_array, is_object, log, log_level_enabled, log_ns_enabled, nullog, or_, partial, say, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __slice = [].slice;
...
// Generated by CoffeeScript 1.6.1
(function() {
  var BUILTIN, CELLS, DNA_DATATYPES, DNA_EXTEND, DNA_ID_PREFIX, DNA_PRIMITIVES, DNA_SUBSCRIBE, FLOAT, FUNCTION, HASHMAP, INTEGER, KEYWORD, Math, NAN, NESTED_EXPR, NULL, PARTIAL_FN, QUOTED_NESTED_EXPR, STRING, THIS, VECTOR, bind_handlers_to_event, bool, complement, compose3, cont_m, cont_t, debug, default_handlers_cont, dispatch_handler, dispatch_impl, distinct, domonad, error, find_cell, fun_with_meta, get_arity, get_cell, get_create_cell, get_create_cell_by_id, get_default_protocols, get_method_ns, get_primitive_value_handler, get_protocol, get_value_handler, info, is_array, is_async, is_function, is_just_function, is_nested_expr, is_null, is_object, is_partial_function, is_value, lift, lift_async, lift_sync, logger_m, logger_t, make_extended_node, make_monadized_handler, make_nested_expr, make_subscribed_node, maybe_m, maybe_t, nullog, parse_genome, partial, process_ast_handler_node, process_meta, process_vector, register_protocol_impl, repeat, save_cell, synthesize_cell, synthesize_node, warn, _ref, _ref1, _ref2, _ref3,
    __slice = [].slice,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
  ...
  synthesize_node = function(dom_parser) {
    ...
    return debug("Cells synthesis completed in " + (new Date - START_TIME) + "ms.");
  };
  ...
  module.exports = {
    run: function() {
      ...
      bt.put_to_queue('init_queue', [
        function() {
          return info("**Starting init queue");
        }, function() {
          return info("**init queue done");
        }
      ]);
    ...
    protocols: {
      definitions: {
        IHelper: [
          ...
          ], ['random', []], ['push-to-google', ['vec']], ['###', ['blk', 'args']], ['wrap', ['wpapper', 'pattern', 'content']]
        ]
      },
      implementations: {
        IHelper: function(node) {
          return {
            wrap: function(wrapper, pattern, content) {
              return wrapper.replace(pattern, content);
            },
            '###': function(block, args) {
              return args;
            },
